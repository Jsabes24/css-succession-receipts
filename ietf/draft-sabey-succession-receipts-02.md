...
docname: draft-sabey-succession-receipts-02
category: info
...
`caid`, byte for byte. The recomputed hash is checked before the
...
binding of {{authorization-binding}}; this document incorporates both.
